			...
			<table class="cpd_list" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						...
						<a onclick="return confirm('Are you sure you want to delete?');" href="<?php echo "$CFG->wwwroot/$CFG->admin/report/cpd/metadata.php?delete=year&id=$year->id" ?>"><img src="<?php echo $CFG->pixpath?>/t/delete.gif" alt="delete" /></a>
					</td>
				</tr>
				<?php
					}
			...
			<table class="cpd_list" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					?>
						...
						<a onclick="return confirm('Are you sure you want to delete?');" href="<?php echo "$CFG->wwwroot/$CFG->admin/report/cpd/metadata.php?delete=status&id=$status->id" ?>">
